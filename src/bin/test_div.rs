use halo2_proofs::{circuit::AssignedCell, dev::MockProver, halo2curves::bn256::Fr};
use zkml::{
    numerics::{
        div::DivChip,
...
#[derive(Clone, Debug)]
pub struct DivConfig<F: PrimeField> {
    pub numeric_config: Rc<NumericConfig>,
    pub public: Column<Instance>,
    pub _marker: PhantomData<F>,
}

pub struct DivCircuit<F: PrimeField> {
    pub input1: Vec<F>,
    pub input2: Vec<F>,
}

impl<F: PrimeField> DivCircuit<F> {
...
impl<F: PrimeField> Circuit<F> for DivCircuit<F> {
